...
const state = {
  ...
  vehicles: [
    ...
    { key: 'phantom3', name: 'Phantom III', type: 'Trailer', requiredLevel: 5, rewards: '$2200-3200 • +3-10 XP', image: 'images/phantom3.png', difficulty: 'hard' },
    { key: 'trailers', name: 'Dry Van', type: 'Trailer', requiredLevel: 5, rewards: '$2200-3200 • +3-10 XP', image: 'images/trailers.png', difficulty: 'hard' },
  ],
  currentSlide: 0,
    ...
    case 'openUI':
      ...
      if (Array.isArray(d.vehicles) && d.vehicles.length) {
        state.vehicles = d.vehicles.map(v => ({
          ...
          type: v.vehicleType || v.typeDisplay || (v.type === 'phantom3' || v.type === 'trailers' ? 'Trailer' : 'Box'),
          requiredLevel: v.requiredLevel ?? 1,
          rewards: v.rewardsText || '$$ • XP',
